    ...
    <div class="center_wrap">
      ...
      <el-form-item label="商品详情:">
         <div class="tiny_con">
            ...
            <editor v-model="SpuForm.desc_detail" :init="init"></editor></div>
      </el-form-item>
      ...
      <el-form-item label="售后服务:">
         <div class="tiny_con">
            <div class="custom_img" @click="pop_show=true"></div><editor v-model="SpuForm.desc_service" :init="init"></editor></div>
      </el-form-item>
